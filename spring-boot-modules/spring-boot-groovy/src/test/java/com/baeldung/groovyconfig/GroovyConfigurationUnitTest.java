package com.nabgc.groovyconfig;
...
import com.nabgc.groovyconfig.BandsBean;
import com.nabgc.groovyconfig.JavaPersonBean;

public class GroovyConfigurationUnitTest {
    
    private static final String FILE_NAME = "GroovyBeanConfig.groovy";
    private static final String FILE_PATH = "src/main/java/com/nabgc/groovyconfig/";
