package com.nabgc.failureanalyzer;

import ch.qos.logback.classic.spi.ILoggingEvent;
import com.nabgc.failureanalyzer.utils.ListAppender;
...
public class FailureAnalyzerAppIntegrationTest {
    ...
    private static final String EXPECTED_ANALYSIS_DESCRIPTION_CONTENT = "The bean myDAO could not be injected as com.nabgc.failureanalyzer.MyDAO because it is of type com.nabgc.failureanalyzer.MySecondDAO";
    private static final String EXPECTED_ANALYSIS_ACTION_TITLE = "Action:";
    private static final String EXPECTED_ANALYSIS_ACTION_CONTENT = "Consider creating a bean with name myDAO of type com.nabgc.failureanalyzer.MyDAO";
