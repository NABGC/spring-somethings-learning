package com.nabgc.kong;

import com.nabgc.kong.domain.APIObject;
import com.nabgc.kong.domain.ConsumerObject;
import com.nabgc.kong.domain.KeyAuthObject;
import com.nabgc.kong.domain.PluginObject;
...
public class KongAdminAPILiveTest {
    ...
    public void givenAdminAPIProxy_whenAddAPIViaProxy_thenAPIAdded() throws Exception {
        ...
        APIObject nabgcAPI = new APIObject("nabgc-api", "nabgc.com", "http://ww.nabgc.com", "/");
        RequestEntity<APIObject> requestEntity = new RequestEntity<>(nabgcAPI, headers, HttpMethod.POST, new URI("http://localhost:8000/admin-api/apis"));
