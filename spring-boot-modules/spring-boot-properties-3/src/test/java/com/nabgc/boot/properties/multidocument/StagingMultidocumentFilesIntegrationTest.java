package com.nabgc.boot.properties.multidocument;
...
import com.nabgc.boot.properties.DemoApplication;
...
public class StagingMultidocumentFilesIntegrationTest {
    ...
    @Test
    @Disabled("Fix and update https://www.nabgc.com/spring-boot-yaml-vs-properties article")
