...
import com.nabgc.autoconfiguration.service.CustomService;
import com.nabgc.autoconfiguration.service.DefaultService;
import com.nabgc.autoconfiguration.service.SimpleService;
...
public class ConditionalOnPropertyIntegrationTest {
    ...
    public void whenGivenCustomPropertyValue_thenCustomServiceCreated() {
        this.contextRunner.withPropertyValues("com.nabgc.service=custom")
    ...
    public void whenGivenDefaultPropertyValue_thenDefaultServiceCreated() {
        this.contextRunner.withPropertyValues("com.nabgc.service=default")
            .withUserConfiguration(SimpleServiceConfiguration.class)
            .run(context -> {
    ...
    protected static class SimpleServiceConfiguration {
        ...
        @Bean
        @ConditionalOnProperty(name = "com.nabgc.service", havingValue = "default")
        ...
        @Bean
        @ConditionalOnProperty(name = "com.nabgc.service", havingValue = "custom")
        @ConditionalOnMissingBean
